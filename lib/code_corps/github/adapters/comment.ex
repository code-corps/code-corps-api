defmodule CodeCorps.GitHub.Adapters.Comment do
  ...
  """
  @spec to_comment(map | GitHubComment.t) :: map
  ...
  def to_comment(%{} = payload) do
    payload
    |> BodyDecorator.remove_code_corps_header
    |> MapTransformer.transform(@github_payload_to_comment_mapping)
  end
  ...
  def to_comment_attrs(%GithubComment{} = github_comment) do
    github_comment
    |> Map.from_struct
    |> MapTransformer.transform_inverse(@github_payload_to_github_comment_mapping)
  end
