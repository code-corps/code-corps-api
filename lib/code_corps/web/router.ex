defmodule CodeCorps.Web.Router do
  ...
  pipeline :current_user do
    plug CodeCorps.Web.Plug.CurrentUser
    plug CodeCorps.Web.Plug.SetSentryUserContext
    plug CodeCorps.Web.Plug.AnalyticsIdentify
  end
