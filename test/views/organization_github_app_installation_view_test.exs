defmodule CodeCorps.OrganizationGithubAppInstallationViewTest do
  ...
  test "renders all attributes and relationships properly" do
    ...
    rendered_json = render(CodeCorps.OrganizationGithubAppInstallationView, "show.json-api", data: organization_github_app_installation)
