defmodule CodeCorps.Web.ErrorViewTest do
  use CodeCorps.Web.ViewCase

  alias CodeCorps.Web.ErrorView

  # Bring render/3 and render_to_string/3 for testing custom views
  import Phoenix.View

  test "renders 404.json-api" do
    rendered_json =  render(ErrorView, "404.json-api", [])
  ...
  test "renders 500.json-api" do
    rendered_json =  render(ErrorView, "500.json-api", [])
  ...
  test "render any other" do
    string = render_to_string(ErrorView, "505.json-api", [])
