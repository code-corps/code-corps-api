defmodule CodeCorps.StripeConnectCustomer do
  ...
  def create_changeset(struct, params \\ %{}) do
    struct
    |> cast(params, [:id_from_stripe, :stripe_connect_account_id, :stripe_platform_customer_id])
    |> validate_required([:id_from_stripe, :stripe_connect_account_id, :stripe_platform_customer_id])
