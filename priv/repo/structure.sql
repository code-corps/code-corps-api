...
--
-- Name: github_comments; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: github_comments id; Type: DEFAULT; Schema: public; Owner: -
--
...
--
-- Name: github_comments github_comments_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: auth_token_value_index; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: github_events_status_index; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: github_repos_project_id_index; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX github_repos_project_id_index ON github_repos USING btree (project_id);
...
CREATE UNIQUE INDEX organization_invites_organization_id_index ON organization_invites USING btree (organization_id);
...
--
-- Name: projects_approval_requested_index; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX projects_approval_requested_index ON projects USING btree (approval_requested);
...
--
-- Name: stripe_external_accounts_id_from_stripe_index; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: stripe_file_upload_id_from_stripe_index; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: task_lists_inbox_index; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: task_lists_order_index; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: tasks_archived_index; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: tasks_number_index; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: tasks_order_index; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: comments comments_github_comment_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: github_comments github_comments_github_issue_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: github_issues github_issues_github_repo_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: github_repos github_repos_project_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
ALTER TABLE ONLY organization_invites
    ADD CONSTRAINT organization_invites_organization_id_fkey FOREIGN KEY (organization_id) REFERENCES organizations(id);
...
--
-- Name: tasks tasks_github_issue_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: user_invites user_invites_invitee_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY user_invites
    ADD CONSTRAINT user_invites_invitee_id_fkey FOREIGN KEY (invitee_id) REFERENCES users(id);


--
-- Name: user_invites user_invites_inviter_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY user_invites
    ADD CONSTRAINT user_invites_inviter_id_fkey FOREIGN KEY (inviter_id) REFERENCES users(id);


--
-- Name: user_invites user_invites_project_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY user_invites
    ADD CONSTRAINT user_invites_project_id_fkey FOREIGN KEY (project_id) REFERENCES projects(id);
